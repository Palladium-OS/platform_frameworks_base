package com.palladium.android.systemui.smartspace
...
class KeyguardSmartspaceController @Inject constructor(
    ...
    init {
        if (!featureFlags.isSmartspaceEnabled()) {
            context.packageManager.setComponentEnabledSetting(ComponentName("com.android.systemui", "com.palladium.android.systemui.keyguard.KeyguardSliceProviderPalladium"), 1, 1)
        } else {
