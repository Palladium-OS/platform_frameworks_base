package com.palladium.android.systemui.keyguard;
...
public class KeyguardSliceProviderPalladium extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<KeyguardSliceProviderPalladium> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(KeyguardSliceProviderPalladium keyguardSliceProviderPalladium, SmartSpaceCard smartSpaceCard) {
            mProviderReference = new WeakReference<>(keyguardSliceProviderPalladium);
            mWeatherCard = smartSpaceCard;
            mBlurRadius = keyguardSliceProviderPalladium.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            KeyguardSliceProviderPalladium keyguardSliceProviderPalladium;
            synchronized (this) {
                mWeatherCard.setIcon(bitmap);
                keyguardSliceProviderPalladium = (KeyguardSliceProviderPalladium) mProviderReference.get();
            }
            if (keyguardSliceProviderPalladium != null) {
                keyguardSliceProviderPalladium.notifyChange();
            }
        }
    ...
    public Slice onBindSlice(Uri uri) {
        Trace.beginSection("KeyguardSliceProviderPalladium#onBindSlice");
        Slice slice;
