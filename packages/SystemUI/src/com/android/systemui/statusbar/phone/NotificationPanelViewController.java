...
import com.android.systemui.PalladiumSystemUIUtils;
...
public class NotificationPanelViewController extends PanelViewController {
    ...
    public NotificationPanelViewController(NotificationPanelView view,
        ...
        mDoubleTapGesture = new GestureDetector(mView.getContext(), new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onDoubleTap(MotionEvent e) {
                PalladiumUtils.switchScreenOff(mView.getContext());
    ...
    public void reTickerView(boolean visibility) {
        if (!PalladiumSystemUIUtils.settingStatusBoolean("reticker_status", mView.getContext())) return;
        ...
        if (visibility && getExpandedFraction() != 1) {
            ...
            if (PalladiumSystemUIUtils.settingStatusBoolean("reticker_colored", mView.getContext())) {
                int col;
    ...
    private void reTickerViewVisibility() {
        if (!PalladiumSystemUIUtils.settingStatusBoolean("reticker_status", mView.getContext())) {
            reTickerDismissal();
            return;
        }
