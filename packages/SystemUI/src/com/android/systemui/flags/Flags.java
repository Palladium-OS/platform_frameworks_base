 ...
 * Ids need not be sequential. Flags can "claim" a chunk of ids for flags in
 * related featurs with
 * a comment. This is purely for organizational purposes.
 *
 * On public release builds, flags will always return their default value. There
 * is no way to
 * change their value on release builds.
 *
 * See {@link FeatureFlagManager} for instructions on flipping the flags via
 * adb.
 */
public class Flags {
        ...
        /***************************************/
        // 100 - notification
        public static final BooleanFlag NEW_NOTIFICATION_PIPELINE = new BooleanFlag(100, true);

        public static final BooleanFlag NEW_NOTIFICATION_PIPELINE_RENDERING = new BooleanFlag(101, false);

        public static final BooleanFlag NOTIFICATION_UPDATES = new BooleanFlag(102, true);

        /***************************************/
        // 200 - keyguard/lockscreen
        public static final BooleanFlag KEYGUARD_LAYOUT = new BooleanFlag(200, true);
        ...
        public static final BooleanFlag CHARGING_RIPPLE = new BooleanFlag(203, false, R.bool.flag_charging_ripple);
        ...
        public static final BooleanFlag SMARTSPACE_SHARED_ELEMENT_TRANSITION_ENABLED = new BooleanFlag(401, false);

        public static final BooleanFlag SMARTSPACE = new BooleanFlag(402, false, R.bool.flag_smartspace);
        ...
        public static final BooleanFlag PEOPLE_TILE = new BooleanFlag(502, false, R.bool.flag_conversations);

        /***************************************/
        // 600- status bar
        public static final BooleanFlag COMBINED_STATUS_BAR_SIGNAL_ICONS = new BooleanFlag(601, false,
                        R.bool.flag_combined_status_bar_signal_icons);
