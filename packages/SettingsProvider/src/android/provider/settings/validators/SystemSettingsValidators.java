...
public class SystemSettingsValidators {
    ...
    static {
        ...
        VALIDATORS.put(System.USE_ACCENTBG, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.HEADSUP_USE_TRANSPARENT_BACKGROUND, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.MAKE_RND, BOOLEAN_VALIDATOR);
    }
}
